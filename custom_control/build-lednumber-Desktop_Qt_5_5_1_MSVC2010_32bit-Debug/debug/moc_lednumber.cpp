...
#include "../../../../../qt5/demo/custom_control/lednumber/lednumber.h"
...
void LedNumber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LedNumber *_t = static_cast<LedNumber *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject LedNumber::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LedNumber.data,
      qt_meta_data_LedNumber,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LedNumber::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LedNumber.stringdata0))
        return static_cast<void*>(const_cast< LedNumber*>(this));
