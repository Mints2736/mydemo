...
#include "../../../../../qt5/demo/custom_control/battery/flatui.h"
...
const QMetaObject FlatUI::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FlatUI.data,
      qt_meta_data_FlatUI,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FlatUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FlatUI.stringdata0))
        return static_cast<void*>(const_cast< FlatUI*>(this));
