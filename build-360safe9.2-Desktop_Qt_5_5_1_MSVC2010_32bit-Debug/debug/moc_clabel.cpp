...
void CLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CLabel::*_t)(CLabel * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CLabel::signalLabelPress)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CLabel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CLabel.data,
      qt_meta_data_CLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
