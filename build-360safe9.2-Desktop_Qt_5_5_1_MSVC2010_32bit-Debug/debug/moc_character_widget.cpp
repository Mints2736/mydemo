/****************************************************************************
** Meta object code from reading C++ file 'character_widget.h'
**
...
#include "../../360safe9.2/character_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'character_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 17), // "changeCurrentPage"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 7) // "CLabel*"

    },
    "CharacterWidget\0changeCurrentPage\0\0"
    "CLabel*"
};
...
void CharacterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeCurrentPage((*reinterpret_cast< CLabel*(*)>(_a[1]))); break;
        default: ;
        }
